...
- [数据目录](oncology-database/data/README.md)
- [药物数据库](oncology-database/data/drugs.md)
- [管线数据库](oncology-database/data/pipelines.md)
- [公司数据库](oncology-database/data/companies.md)
- [FDA 批准记录](oncology-database/data/fda_approvals.md)
- [术语缩写表](oncology-database/data/terms.md)
...
2. 更新数据表文件：
   ...
   - `oncology-database/data/drugs.md`：新增或修订药物、靶点、适应症、关键试验和章节引用。
   - `oncology-database/data/pipelines.md`：更新临床阶段、试验编号、预计读出时间和合作方。
   - `oncology-database/data/companies.md`：更新公司管线、并购、授权和战略布局。
   - `oncology-database/data/fda_approvals.md`：更新 FDA 批准、撤销、适应症扩展和标签变化。
   - `oncology-database/data/terms.md`：补充新术语、缩写和中文解释。
   - `oncology-database/data/README.md`：如新增或删除数据表，需要同步更新数据目录。

3. 更新 Markdown 正文：

   - 总目录：`oncology-database/index.md`
   - 章节正文：`oncology-database/chapters/*.md`
   - 如果新增章节，需同时更新根目录 `README.md`、`oncology-database/README.md` 和 `oncology-database/index.md` 中的目录链接。
