...
OncoAtlas 是一个面向生命科学研究生和研发从业者的中文知识数据库，按 Markdown 文档形式组织，便于直接在 GitHub 阅读、检索和引用。

## 快速入口

- [项目说明](README.md)
- [结构化药物数据](data/drugs.json)
- [管线数据](data/pipelines.json)
- [公司数据](data/companies.json)
- [FDA 批准记录](data/fda_approvals.json)
- [术语表](data/terms.json)
...
- 内容版本：2025.Q2。
- 适用于教育和研究，不构成医疗、监管或投资建议。
- 快速变化的信息（批准状态、价格、交易、临床阶段）应回到 FDA、ClinicalTrials.gov、公司公告和同行评议论文复核。
